...
var commodity = {
  ...
  time:{
    start:moment().add(10,'minutes').format('YYYY-MM-DD HH:mm'),
    end:moment().add(2,'months').format('YYYY-MM-DD HH:mm')
  },
  money:{
    price:0,
    discount:0,
...
var tinymceOptions = {
  ...
  'toolbar': ' bold italic underline | bullist numlist | alignleft aligncenter alignright alignjustify | forecolor backcolor'+
          ' fontsizeselect | link image emoticons insertdatetime | removeformat undo redo | code preview',//media
